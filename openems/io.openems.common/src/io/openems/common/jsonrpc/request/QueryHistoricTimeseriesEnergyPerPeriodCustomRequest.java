...
public class QueryHistoricTimeseriesEnergyPerPeriodCustomRequest extends JsonrpcRequest {

	public static final String METHOD = "queryHistoricTimeseriesEnergyPerPeriod2";

	
	
	/**
	 * Create {@link QueryHistoricTimeseriesEnergyPerPeriodCustomRequest} from a template
	 * {@link JsonrpcRequest}.
	 *
	 * @param r the template {@link JsonrpcRequest}
	 * @return the {@link QueryHistoricTimeseriesEnergyPerPeriodCustomRequest}
	 * @throws OpenemsNamedException on parse error
	 */
	public static QueryHistoricTimeseriesEnergyPerPeriodCustomRequest from(JsonrpcRequest r) throws OpenemsNamedException {
		var p = r.getParams();
		...
		var result = new QueryHistoricTimeseriesEnergyPerPeriodCustomRequest(r, fromDate, toDate, resolution);
	...
	private QueryHistoricTimeseriesEnergyPerPeriodCustomRequest(JsonrpcRequest request, ZonedDateTime fromDate,
			ZonedDateTime toDate, Resolution resolution) throws OpenemsNamedException {
		super(request, QueryHistoricTimeseriesEnergyPerPeriodCustomRequest.METHOD);
	...
	public QueryHistoricTimeseriesEnergyPerPeriodCustomRequest(ZonedDateTime fromDate, ZonedDateTime toDate,
			Resolution resolution) throws OpenemsNamedException {
		super(QueryHistoricTimeseriesEnergyPerPeriodCustomRequest.METHOD);
	...
	public JsonObject getParams() {
		...
		return JsonUtils.buildJsonObject() //
				.addProperty("fromDate", QueryHistoricTimeseriesEnergyPerPeriodCustomRequest.FORMAT.format(this.fromDate)) //
				.addProperty("toDate", QueryHistoricTimeseriesEnergyPerPeriodCustomRequest.FORMAT.format(this.toDate)) //
