 ...
 * </pre>
 */
public class QueryHistoricTimeseriesEnergyPerPeriodCustomResponse extends JsonrpcResponseSuccess {

	private final SortedMap<ZonedDateTime, SortedMap<ChannelAddress, JsonElement>> table;

	public QueryHistoricTimeseriesEnergyPerPeriodCustomResponse(
			SortedMap<ZonedDateTime, SortedMap<ChannelAddress, JsonElement>> table) {
		this(UUID.randomUUID(), table);
	}

	public QueryHistoricTimeseriesEnergyPerPeriodCustomResponse(UUID id,
			SortedMap<ZonedDateTime, SortedMap<ChannelAddress, JsonElement>> table) {
		super(id);
		this.table = table;
	}
