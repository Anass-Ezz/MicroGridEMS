...
public interface ElectricityMeter extends OpenemsComponent {
	...
	public static ModbusSlaveNatureTable getModbusSlaveNatureTable(AccessMode accessMode) {
		return ModbusSlaveNatureTable.of(ElectricityMeter.class, accessMode, 200) //
				...
				.channel(135, ChannelId.POWER_FACTOR_L1, ModbusType.FLOAT32) //
				.channel(136, ChannelId.POWER_FACTOR_L2, ModbusType.FLOAT32) //
				.channel(137, ChannelId.POWER_FACTOR_L3, ModbusType.FLOAT32) //
				.channel(138, ChannelId.POWER_FACTOR, ModbusType.FLOAT32) //
				.build();
	}
